...
function offsetMomentum(b, size)
...
offsetMomentum(bodies, size)

--io.write( string.format("%0.9f",energy(bodies)), "\n")
io.write( string.format("%0.9f",energy(bodies, size)), "\n")
--for i = 1,n do advance(bodies,0.01) end
for i = 1,n do advance(bodies,size,0.01) end
--io.write( string.format("%0.9f",energy(bodies)), "\n")
io.write( string.format("%0.9f",energy(bodies, size)), "\n")
